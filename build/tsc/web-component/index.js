class PdbTopologyViewer extends HTMLElement {
    ...
    validateParams() {
        if (typeof this.entryId == 'undefined' || typeof this.entityId == 'undefined' || this.entryId == null || this.entityId == null)
            return false;
        return true;
    }
    invokePlugin() {
        ...
        if (typeof this.pluginInstance == 'undefined')
            this.pluginInstance = new PdbTopologyViewerPlugin();
        let options = {
            entryId: this.entryId,
            entityId: this.entityId,
        };
        if (typeof this.chainId !== 'undefined' && this.chainId !== null)
            options['chainId'] = this.chainId;
        if (typeof this.displayStyle !== 'undefined' && this.displayStyle !== null)
            options['displayStyle'] = this.displayStyle;
        if (typeof this.errorStyle !== 'undefined' && this.errorStyle !== null)
            options['errorStyle'] = this.errorStyle;
        if (typeof this.menuStyle !== 'undefined' && this.menuStyle !== null)
            options['menuStyle'] = this.menuStyle;
        if (typeof this.subscribeEvents !== 'undefined' && this.subscribeEvents !== null)
            options['subscribeEvents'] = this.subscribeEvents;
